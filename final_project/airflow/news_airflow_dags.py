...
def is_store(ti):
    ...
    sql_alchemy_conn = "mysql://USERNAME:multi1234!!@ec2-54-249-233-132.ap-northeast-1.compute.amazonaws.com:3306/django_dataset?charset=utf8mb4"
...
def telegram():
    ...
    URL = 'https://api.telegram.org/bot7101142111:AAEnPkma1ea0jDcmRupnPh6ihnC4kxagxX4/sendMessage?chat_id=6965081843&text='
    # URL = 'https://api.telegram.org/bot7101142111:AAEnPkma1ea0jDcmRupnPh6ihnC4kxagxX4/sendMessage?chat_id=-1002042663556&text='
    #URL = 'https://api.telegram.org/bot7199893980:AAG3_CbtQw1Ii7n5fyabHzyOmXK9uNjt2pU/sendMessage?chat_id=-1002042663556&text='
    ...
    #     message += f"<b>{row['title']}</b>\n{row['abstract']}\n\n"
    # message += f"더 많은 정보가 궁금하다면! <a href='54.249.233.132:8000/home'>KSC.com</a>"
    # # 텔레그램 채널 ID이랑 봇 토큰 사용하여 메시지를 전송
    # channel_id = "+a2yNXHreByE0NjNl"
    # bot_token = "7101142111:AAEnPkma1ea0jDcmRupnPh6ihnC4kxagxX4"
